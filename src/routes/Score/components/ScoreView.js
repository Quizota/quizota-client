                  ...
                  <div className='wrapper-rank'>
                    ...
                    <div className='rank-bar-wrapper'>
                      <div className='rank-bar'
                        style={{ transform: `translate(-69.2982%, 0%) translate3d(0px, 0px, 0px)` }} />
                    </div>
                    <div className='rank-bar-end' />
                  </div>
                </div>
                <div className='stats-learn-container'>
                  ...
                  <div className='learn-wrapper' style={{ zIndex: `0` }}>
                    <div className='wrap-bg-ie'>
                      <div className='ghost-blue' />
                      <div className='deilor-img' />
                    </div>
                      ...
                      <svg width='200' height='200'>
                        <defs>
                          <clipPath id='mask-product'>
                            <rect x='10' y='20' width='319' height='300' />
                          </clipPath>
                          <clipPath id='mask-product-ld'>
                            <rect x='10' y='20' width='282' height='267' />
                          </clipPath>
                        </defs>
                      </svg>
                    </div>
                  ...
                  <svg width='200' height='200'>
                    <defs>
                      <clipPath id='mask-ticket'>
                        <rect x='20' y='20' width='319' height='440' />
                      </clipPath>
                      <clipPath id='mask-ticket-ld'>
                        <rect x='20' y='20' width='282' height='394' />
                      </clipPath>
                    </defs>
                  </svg>
                </div>
