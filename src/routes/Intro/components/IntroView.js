          ...
          <div className='wrap-pers'>
            <div className='wrap'>`
              <div id='ws2' className='logo' >
                <svg className='Intro__logo Intro__logo--Quizota' viewBox='0 0 442.5 132.8' version='1.1' data-reactid='.co531mtm9s.0.0.0.0.0' style={{ fill: `#ffffff` }}>
                  <g id='XMLID_36_'>
                    <g id='XMLID_4_'>
                      <g id='Logo-Copy_8_' transform='translate(46.000000, 89.000000)'>
                        <g id='Group-30_8_'>
                          <path id='Fill-252_8_' className='st0' d='M-20-17.6C-7-4.6,14-4.6,27-17.6c1.6-1.6,1.6-4.3,0-5.9s-4.3-1.6-5.8,0
					c-4.9,4.9-11.2,7.3-17.6,7.3s-12.8-2.4-17.6-7.3c-1.6-1.6-4.3-1.6-5.9,0C-21.6-21.8-21.6-19.2-20-17.6' />
                          <circle id='Oval-2_17_' className='st0' cx='-10.4' cy='-48.7' r='7.1' />
                          <circle id='Oval-2_16_' className='st0' cx='18' cy='-48.7' r='7.1' />
                          <path id='Fill-253_8_' className='st0' d='M-8.7,35.5h24.9c2.3,0,4.1-1.9,4.1-4.2c0-2.3-1.9-4.1-4.1-4.1H-8.7
					c-2.3,0-4.1,1.9-4.1,4.1S-10.9,35.5-8.7,35.5' />
                          <path id='Fill-254_8_' className='st0' d='M-12.8,18.9h33.2c2.3,0,4.2-1.9,4.2-4.1s-1.9-4.2-4.2-4.2h-33.2c-2.3,0-4.2,1.9-4.2,4.2
					S-15.1,18.9-12.8,18.9' />
                          <path id='Fill-255_8_' className='st0' d='M30.1-7.2c-5.8,4.7-9.7,11.7-9.7,19.6v14.9h-7.9l-1,2.8c-1.1,3.1-4.2,5.5-7.8,5.5
                    ...
                    <g id='XMLID_2_'>
                      <path id='XMLID_3_' className='st0' d='M107.1,65.5c0-5.6,1-10.6,2.9-14.9c1.9-4.4,4.5-8.1,7.7-11.1c3.2-3,6.9-5.4,11.1-7
			...
			c-2.1,2.1-3.8,4.6-5.1,7.7C119.6,57.8,118.9,61.4,118.9,65.5z' />
                      <path id='XMLID_9_' className='st0' d='M218,94.4c-1.2,2.1-3,3.7-5.4,4.9c-2.5,1.1-5.1,1.7-7.8,1.7c-2.8,0-5.3-0.5-7.5-1.4
			...
			c0,1.9,0,3.6,0.1,5c0.1,1.4,0.2,2.6,0.3,3.5h-10.7c-0.1-0.5-0.2-1.3-0.3-2.3C218,96.3,218,95.4,218,94.4z' />
                      <path id='XMLID_11_' className='st0' d='M240.7,36.3c0-2.1,0.7-3.8,2.1-5.2c1.4-1.4,3.1-2.1,5.1-2.1c2.1,0,3.8,0.7,5.2,2.1
			...
			z M242.4,99.6V52.8h11.1v46.8H242.4z' />
                      <path id='XMLID_14_' className='st0' d='M264.7,99.6v-9.7l23.7-27.3h-23.3v-9.8h37.3v9.4l-24,27.6H303v9.8H264.7z' />
                      <path id='XMLID_16_' className='st0' d='M334.9,51.3c3.5,0,6.8,0.6,9.7,1.9c2.9,1.2,5.5,3,7.7,5.2c2.2,2.2,3.9,4.8,5.1,7.8
			...
			c-0.7,1.8-1.1,4-1.1,6.4c0,2.4,0.4,4.6,1.1,6.4c0.7,1.9,1.7,3.4,2.9,4.7c1.2,1.2,2.6,2.2,4.1,2.8C331.5,90.7,333.2,91,334.9,91z' />
                      <path id='XMLID_19_' className='st0' d='M384,52.8h9.7v9.9H384v21.7c0,2.1,0.5,3.5,1.4,4.5c1,0.9,2.5,1.4,4.5,1.4c0.8,0,1.5,0,2.3-0.1
			...
			c-2.5-2.4-3.7-5.9-3.7-10.3V62.7h-8.7v-9.9h2.4c2.5,0,4.3-0.7,5.5-2.1c1.2-1.4,1.7-3.1,1.7-5.2v-7H384V52.8z' />
                      <path id='XMLID_21_' className='st0' d='M401.4,86.9c0-2.1,0.4-4,1.1-5.6c0.7-1.6,1.7-3,3-4.2c1.2-1.2,2.7-2.1,4.5-2.8
